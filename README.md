...
노션 데이터베이스에서 **마감일이 D-3 이내인 채용 공고**를 조회하여
매일 오전 9시에 디스코드 채널로 자동 알림을 전송합니다.

- 📅 마감일 기준 D-3 이내 공고 자동 감지
- 🎨 D-day 기준 색상 이모지 구분 (🔴 오늘 / 🟠 D-1 / 🟡 D-2 / 🟢 D-3)
